...
def expand_hotspot(name, lat, lng, intensity, count=8, spread=0.015):
...
# Add HeatMap layer — blue/cyan gradient, radius kept under 60 to avoid black squares
HeatMap(
    heat_data,
    radius=58,
    blur=55,
...
# Add markers directly to map (no MarkerCluster) so sidebar interaction works
